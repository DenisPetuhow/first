...
|---|---|
| файлов кода | 47 |
| строк кода | 18303 ≈ 237 тыс. токенов |
| строк карты | 770 ≈ 6 тыс. токенов |
...
|---|---|---|---|---|---|
| `model/threat_grid.py` | 3234 | 42042 | 2 | 131 | [КАРТА_1.md](КАРТА_1.md) стр. **10** |
| `view_qt/threat_view.py` | 2984 | 38792 | 6 | 136 | [КАРТА_1.md](КАРТА_1.md) стр. **168** |
| `model/threat_routes.py` | 1217 | 15821 | 0 | 26 | [КАРТА_1.md](КАРТА_1.md) стр. **328** |
| `tools/переносимое/make_figures.py` | 1090 | 14170 | 0 | 26 | [КАРТА_1.md](КАРТА_1.md) стр. **362** |
| `controller_qt/threat_controller.py` | 893 | 11609 | 3 | 50 | [КАРТА_1.md](КАРТА_1.md) стр. **394** |
| `config.py` | 826 | 10738 | 1 | 3 | [КАРТА_1.md](КАРТА_1.md) стр. **472** |
| `model/trajectories.py` | 708 | 9204 | 0 | 39 | [КАРТА_1.md](КАРТА_1.md) стр. **493** |
| `view_qt/view_qt.py` | 514 | 6682 | 2 | 45 | [КАРТА_1.md](КАРТА_1.md) стр. **538** |
| `view_qt/geomap.py` | 481 | 6253 | 0 | 20 | [КАРТА_1.md](КАРТА_1.md) стр. **593** |
| `tools/переносимое/codemap.py` | 451 | 5863 | 0 | 15 | [КАРТА_1.md](КАРТА_1.md) стр. **619** |
| `view/view.py` | 414 | 5382 | 1 | 33 | [КАРТА_1.md](КАРТА_1.md) стр. **642** |
| `model/area_start.py` | 396 | 5148 | 1 | 28 | [КАРТА_1.md](КАРТА_1.md) стр. **689** |
| `main_qt.py` | 354 | 4602 | 0 | 5 | [КАРТА_1.md](КАРТА_1.md) стр. **731** |
| `view_qt/area_view.py` | 306 | 3978 | 1 | 18 | [КАРТА_1.md](КАРТА_1.md) стр. **742** |
...
| `view_qt/map_image.py` | 276 | `images_dir`, `coords_from_name`, `load_image_rgba`, `MapImageDialog`, `__init__`, `_pick`, `_values`, `_apply`, `_clear`, `make_image_item`, `place_image` |
...
| `tools/переносимое/check_names.py` | 239 | `_find_root`, `collect_code_names`, `is_noise`, `docs`, `main` |
...
| `tools/reference_run.py` | 208 | `_fmt`, `main` |
...
| `tools/flow_check.py` | 165 | `check`, `step`, `main` |
...
| `tools/gui_check.py` | 132 | `check`, `main` |
