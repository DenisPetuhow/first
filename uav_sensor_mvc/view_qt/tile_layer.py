...
class _TileImage(pg.ImageItem):
    """Картинка тайла, которая рисуется СО СГЛАЖИВАНИЕМ.

    ⚠️ ТОЛЬКО ТАЙЛЫ, И ЭТО ВАЖНО. Сглаживание сначала включили у всего виджета — и вместе
    с подложкой размылась ВЕСОВАЯ КАРТА: её ячейки 500 м должны читаться квадратиками,
    это и есть способ увидеть сетку расчёта (замечание заказчика 13.09.2026). У тайла
    пиксель — часть рисунка, у весовой ячейки — единица данных; сглаживать нужно первое
    и нельзя второе."""
