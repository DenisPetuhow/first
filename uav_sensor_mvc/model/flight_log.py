...
Формат и все семь общих правил ввода-вывода — теория/модель/МЕТОДИЧКА_ВВОД_ВЫВОД.md §2, §5.
...
def check_compatible(routes, report):
    ...
    вопросы»; теория/модель/МЕТОДИЧКА_ВВОД_ВЫВОД.md §5): координаты в градусах самодостаточны,
