...
ETALON = {
    ...
    # Условия замера: рельеф ВКЛЮЧЁН (`set_relief(True)` до `build()`), 15 малых датчиков
    # (`--sensors 15`, умолчание программы 20), 250 возможных маршрутов, 150 итераций,
    ...
    "arh": {
        ...
        "область залёта":     (22168, 0),
        "L_max":              (203.4, 0.1),
        "длина средняя":      (142.4, 4.5),
        "длина максимум":     (197.0, 7.0),
        "средняя кратность":  (7.55, 0.7),
    },
    "plesetsk_wide": {
        "сетка":              ((192, 110), 0),
        "коридоров":          (1875, 0),
